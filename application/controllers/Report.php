...
class Report extends CI_Controller
{
  ...
  function transaksikeluar($id_transaksi)
  {
    $data = array('id_transaksi' => $id_transaksi);
    $this->load->view('user/cetak_transaksikeluar', $data);
  }

  function lap_produkkeluar()
  {
    $data['list_data'] = $this->M_user->join_cetaktbkeluar()->result();
    $this->load->view('user/cetak_transaksikeluar2', $data);
  }
  ...
  public function barangKeluarManual()
  {
    ...
    // document informasi
    $pdf->SetCreator('CV. Greenlife Tirta Sentosa');
    $pdf->SetTitle('Sistem Informasi Gudang - Produk Keluar');
    $pdf->SetSubject('Produk Keluar');

    //header Data
    $pdf->SetHeaderData('cvgts.png',30,'Laporan Data','Produk Keluar',array(203, 58, 44),array(0, 0, 0));
      ...
      '<div>
        ...
        <table border="1">
          <tr>
            ...
            <th style="width:140px" align="center">Produk</th>
  ...
  public function barangKeluar()
  {
    ...
    $data = $this->M_user->join_tbkeluar()->result();
    ...
    $html=
      '<div>
        <h1 align="center">Invoice Bukti Pengeluaran Produk</h1><br>
        <p align="center">No Id Transaksi  : '.$id.' | 
        Ditunjukan Untuk : Bapak Agus Salim | 
        Tanggal          : '.$tgl1.'/'.$tgl2.'/'.$tgl3.'</p>


        <table border="1">
          <tr>
            <th style="width:50px" align="center">No</th>
            <th style="width:150px" align="center">ID Transaksi</th>
            <th style="width:110px" align="center">Tanggal Masuk</th>
            <th style="width:110px" align="center">Tanggal Keluar</th>
            <th style="width:130px" align="center">Lokasi</th>
            <th style="width:180px" align="center">Nama Produk</th>
            <th style="width:100px" align="center">Satuan</th>
            <th style="width:80px" align="center">Jumlah</th>
          </tr>';
          ...
          foreach($data as $d){
            ...
            $html .= '<td align="center">'.$d->nama_produk.'</td>';
