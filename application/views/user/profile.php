...
<div class="content-wrapper"><!--Start Content Wrapper-->
  ...
  <div class="col-md-3">
    ...
    <div class="card-body box-profile">
      ...
      <a href="<?= base_url('user/sigout'); ?>" class="btn btn-danger btn-block"><b>LOGOUT</b></a>
    </div>
    </div><!-- Profile Image -->
  </div>
    ...
    <div class="card">
      ...
      <div class="tab-pane" id="picture">
        <form class="form-horizontal" action="<?=base_url('user/proses_gambar_upload')?>" method="post" enctype="multipart/form-data">
