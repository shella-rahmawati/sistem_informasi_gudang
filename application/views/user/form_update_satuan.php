...
<div class="content-wrapper"><!--Start Content Wrapper-->
  ...
  <div class="card-body">
  <div class="box-body">
    <form action="<?=base_url('user/proses_satuan_update')?>" role="form" method="post">
    ...
    <?php } ?>
      ...
      <div class="box-body">
        ...
        <a type="button" class="btn btn-info" style="width:29%;margin-right:20%" href="<?=base_url('user/tabel_satuan')?>" name="btn_listbarang"><i class="fa fa-table" aria-hidden="true"></i> Lihat List Satuan</a>
