  ...
  <div class="box-body">
    <form action="<?=base_url('admin/proses_databarang_masuk_insert')?>" role="form" method="post">
      ...
      <div class="form-group" style="display:inline">
        ...
        <input type="number" name="jumlah" style="width:50%;margin-left:34px;margin-right:18px;" class="form-control" id="jumlah" placeholder="Jumlah">
      </div>
      <div class="form-group" style="display:inline;">
      ...
      <div class="box-body">
        ...
        <a type="button" class="btn btn-info" style="width:29%;margin-right:20%" href="<?=base_url('admin/tabel_barangmasuk')?>" name="btn_listbarang"><i class="fa fa-table" aria-hidden="true"></i> Lihat List Barang</a>
