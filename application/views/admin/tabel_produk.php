      ...
      <font size="3"><table id="example1" class="table table-bordered table-striped" width="100%">
        ...
        <tr>
          ...
          <?php foreach($join_produk as $dd): ?>
            ...
            <a type="button" class="btn btn-warning btn-detail btn-xs"  href="<?=base_url('admin/detail_produk/'.$dd->id_produk)?>" name="btn_detail" style="margin:auto;"><i class="fas fa-eye" aria-hidden="true"></i></a>
            <a type="button" class="btn btn-primary btn-xs" href="<?=base_url('admin/update_produk/'.$dd->id_produk)?>" name="btn_update" style="margin:auto;"><i class="fas fa-edit" aria-hidden="true"></i></a>
            <a type="button" class="btn btn-danger btn-delete btn-xs"  href="<?=base_url('admin/delete_produk/'.$dd->id_produk)?>" name="btn_delete" style="margin:auto;"><i class="fas fa-trash" aria-hidden="true"></i></a>
            </div>
          </td>
        </tr>
      <?php $no++; ?>
...
<div class="modal fade" id="modal-lg"><!--Modal Input-->
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <form action="<?=base_url('admin/proses_produk_insert')?>" role="form" method="post">
...
<!--<div class="modal fade" id="modal-edit">
  <div class="modal-dialog modal-edit">
    <div class="modal-content">
      <form action="<?=base_url('admin/proses_produk_update')?>" role="form" method="post">
    <?php if($this->session->flashdata('msg_berhasil')){ ?>
