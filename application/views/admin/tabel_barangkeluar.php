...
<div class="content-wrapper"><!--Start Content Wrapper-->
  ...
  <div class="container-fluid">
    <div class="row" style="margin-bottom: 10px">
        <div class="col-md-6">
          <a href="<?=base_url('admin/tabel_barangmasuk')?>" type="button" class="btn btn-primary" name="tambah_data"><i class="fa fa-plus-circle" aria-hidden="true"></i> Tambah Data Keluar</a>
